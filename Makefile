...
ICON_NANOS = icons/app_pbc_16px.gif
ICON_NANOX = icons/app_pbc_14px.gif
ICON_NANOSP = icons/app_pbc_14px.gif
ICON_STAX = icons/app_pbc_32px.gif
...
PATH_APP_LOAD_PARAMS = "44'/3757'"   # purpose=coin(3757) / coin_type=Mainnet(0)
